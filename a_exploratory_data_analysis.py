...
eur_usd_converter = pd.read_csv('CurrencyData.csv', sep=',', header=0, parse_dates=['date'], dayfirst=True)
...
for column in ['px_open', 'px_high', 'px_low', 'px_last']:
    dict_markets['RX1_index'][column] = dict_markets['RX1_index'][column] * eur_usd_converter
