...
transitions = {'full_transition': {'days': [1], 'portions': [1]},
...
def benchmark_process(filename):
    ...
    #% Set class
    signal_class = sac.signals_analysis(filename, wd_main, wd_data, wd_other_data, wd_export)
    
    #% Export der Benchmark-Daten
    for transition in transitions.keys():
        signal_class.export_kind = transition #Transition fließt in den Exportnamen ein
